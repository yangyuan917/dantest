...
export default {
  ...
  methods: {
    ...
    async getData() {
      let data = await aip0.get('/operation')
      data = data.data;
    ...
    async getData0() { //获取对应的数据
      let data = await aip0.get('/maro_rate')
      data = data.data;
      const formattedData = Object.keys(data.data).map(key => {
    ...
    async getData1() { //获取对应的数据
      let data = await aip0.get('/index_cnbd')
      data = data.data;
      const formattedData = Object.keys(data.data).map(key => {
    ...
    async getData_fundflow50() { //获取对应的数据
      let data = await aip0.get('/fund_flow?tag=上证50')
      data = data.data;
      const formattedData = Object.keys(data.data).map(key => {
    ...
    async getData2() { //获取对应的数据
      let data = await aip0.get('/fund_flow?tag=沪深300')
      data = data.data;
    ...
    async getData_fundflow1000() { //获取对应的数据
      let data = await aip0.get('/fund_flow?tag=中证1000')
      data = data.data;
    ...
    async getData_new_fund_flow() { //获取对应的数据
      let data = await aip0.get('/new_fund_flow')
      data = data.data;
    ...
    async getData_north_flow() { //获取对应的数据
      let data = await aip0.get('/north_flow')
      data = data.data;
    ...
    async getData_scores_short(selectedTarget,start_date) { //获取对应的数据
      let data = await aip0.get('/scores_short?target=' + selectedTarget)
      data = data.data;
    ...
    async getData_scores_short1(selectedTarget, start_date) { //获取对应的数据
      let data = await aip0.get('/scores_short1?target=' + selectedTarget + '&start_date=' + start_date)
      data = data.data;
