...
export default {
  ...
  methods: {
    ...
    async getData_fundflow50() { //获取对应的数据
      let data = await api0.get('/fund_flow?tag=上证50')
      data = data.data;
    ...
    async getData2() { //获取对应的数据
      let data = await api0.get('/fund_flow?tag=沪深300')
      data = data.data;
    ...
    async getData_fundflow1000() { //获取对应的数据
      let data = await api0.get('/fund_flow?tag=中证1000')
      data = data.data;
    ...
    async getData_new_fund_flow() { //获取对应的数据
      let data = await api0.get('/new_fund_flow')
      data = data.data;
    ...
    async getData_north_flow() { //获取对应的数据
      let data = await api0.get('/north_flow')
      data = data.data;
